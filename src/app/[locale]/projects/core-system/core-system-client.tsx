...
function NumberedContentCard({
  ...
  return (
    <div
      className={`p-4 rounded-2xl ${bgClass} border ${colorClass} flex flex-col md:flex-row gap-4 items-start md:items-center w-full`}
    >
      <span className="text-[28px] font-heading font-bold leading-none shrink-0 text-text-muted">
        {number}
      </span>
      <p className="font-light text-[16px] leading-7 text-text-primary flex-1">
        {text}
      </p>
    </div>
  );
...
function ColoredContentCard({
  ...
  return (
    <div
      className={`p-4 rounded-2xl ${bgClass} border ${colorClass} w-full flex gap-4 items-start`}
    >
      {label && (
        <span
          className={`text-4xl font-heading font-bold leading-none shrink-0 opacity-0`}
        >
          {label}
        </span>
      )}
    ...
    <li className="flex items-start gap-3">
      {type === "improvement" ? (
        <svg
          ...
          className="shrink-0 mt-1 text-accent-green"
        >
        ...
        <svg
          ...
          strokeLinecap="round"
          strokeLinejoin="round"
          className="shrink-0 mt-1 text-accent-red"
        >
      ...
      <span
        className={`text-base md:text-[18px] leading-7.5 font-normal ${type === "improvement" ? "text-accent-green" : "text-accent-red"}`}
      >
        {text}
      </span>
    </li>
...
export default function CoreSystemCase() {
  ...
  const sections = [
    {
      ...
      step: tc("steps.discover"),
      color: PHASE_COLORS.discover,
    },
    {
      id: "define",
      label: t("sections.define"),
      step: tc("steps.define"),
      color: PHASE_COLORS.define,
    },
    {
      id: "solution",
      label: t("sections.solution"),
      step: tc("steps.solution"),
      color: PHASE_COLORS.solution,
    },
    {
      id: "results",
      label: t("sections.results"),
      step: tc("steps.results"),
      color: PHASE_COLORS.results,
    },
    {
      id: "next-steps",
      label: t("sections.nextSteps"),
      step: tc("steps.nextSteps"),
  ...
  const metadata = [
    ...
    {
      label: t("metadata.duration.label"),
      value: t("metadata.duration.value"),
    },
    {
      label: t("metadata.platform.label"),
      value: t("metadata.platform.value"),
    },
  ...
  return (
    ...
    >
      ...
      <div className="rounded-2xl border border-border bg-bg-elevated p-4">
        <p className="text-text-primary font-light leading-7">
          {t("confidentiality")}
        </p>
      </div>
      ...
      <section className="py-8 border-b border-border">
        <h2 className="text-heading-02 text-text-primary mb-4">
          {t("overview.title")}
        </h2>
        <div className="text-body-01 text-text-secondary mb-12 max-w-187.5 space-y-6">
          <p>{t("overview.p1")}</p>
          <p>{t("overview.p2")}</p>
        </div>
        ...
        <div className="text-body-01 text-text-secondary max-w-187.5 space-y-4">
          <p>{t("role.p1")}</p>
          <p>{t("role.p2")}</p>
          <p>{t("role.p3")}</p>
        </div>
      ...
      >
        <div className="space-y-8 mb-12">
          <div>
            <h3 className="text-xl font-heading font-bold text-text-primary mb-4">
              {t("discover.dashboard.title")}
            </h3>
            <div className="flex flex-col md:flex-row gap-4">
              <NumberedContentCard
                number="01"
                text={t("discover.dashboard.gaps.0")}
              />
              <NumberedContentCard
                number="02"
                text={t("discover.dashboard.gaps.1")}
              />
            </div>
          </div>
          ...
          <div>
            <h3 className="text-xl font-heading font-bold text-text-primary mb-4">
              {t("discover.inbox.title")}
            </h3>
            <div className="flex flex-col md:flex-row gap-4">
              <NumberedContentCard
                number="01"
                text={t("discover.inbox.gaps.0")}
              />
              <NumberedContentCard
                number="02"
                text={t("discover.inbox.gaps.1")}
              />
            </div>
          </div>
          ...
          <div>
            <h3 className="text-xl font-heading font-bold text-text-primary mb-4">
              {t("discover.processing.title")}
            </h3>
            <div className="flex flex-col md:flex-row gap-4">
              <NumberedContentCard
                number="01"
                text={t("discover.processing.gaps.0")}
              />
              <NumberedContentCard
                number="02"
                text={t("discover.processing.gaps.1")}
              />
            </div>
          </div>
        </div>
        ...
        <p className="text-body-01 text-text-secondary mb-6 max-w-187.5">
          {t("discover.evident")}
        </p>
      ...
      >
        <div className="space-y-12">
          ...
          <div className="flex flex-col xl:flex-row gap-6 items-start">
            <div className="w-full xl:w-162.5 shrink-0">
              <ImageCard
            ...
            <div className="flex-1 space-y-4 w-full">
              <h3 className="text-2xl md:text-3xl font-heading font-bold text-text-primary">
                {t("define.dashboard.title")}
              </h3>
              <p className="text-base md:text-body-01 text-text-primary">
                {t("define.dashboard.subtitle")}
              </p>
              <ColoredContentCard
          ...
          <div className="flex flex-col xl:flex-row gap-6 items-start">
            <div className="flex-1 space-y-4 w-full order-2 xl:order-1">
              <h3 className="text-2xl md:text-3xl font-heading font-bold text-text-primary">
                {t("define.inbox.title")}
              </h3>
              <p className="text-base md:text-body-01 text-text-primary">
                {t("define.inbox.subtitle")}
              </p>
              <ColoredContentCard
            ...
            <div className="w-full xl:w-162.5 shrink-0 order-1 xl:order-2">
              <ImageCard
      ...
      {/* DEFINE → SOLUTION TRANSITION */}
      <div className="py-ds-lg text-center">
        <p className="text-2xl md:text-[32px] leading-tight font-heading font-bold text-text-primary max-w-187.5 mx-auto">
      ...
      <SolutionRenderer
        ...
        description={t("solution.intro")}
      >
        <div className="space-y-8">
          <VideoCard
            videoDescription={t("solution.videoCaption")}
          ...
          <div>
            ...
            <ColoredContentCard
              text={t("solution.dashboard.text")}
          ...
          <div>
            <h3 className="text-xl font-heading font-bold text-text-primary mb-4">
              {t("solution.inbox.title")}
            </h3>
            <ColoredContentCard
              text={t("solution.inbox.text")}
              bgClass="bg-accent-pink/10"
              colorClass="border-accent-pink"
            />
          </div>
          ...
          <div>
            <h3 className="text-xl font-heading font-bold text-text-primary mb-4">
              {t("solution.caseManagement.title")}
            </h3>
            <ColoredContentCard
              text={t("solution.caseManagement.text")}
              bgClass="bg-accent-pink/10"
              colorClass="border-accent-pink"
            />
          </div>

          {/* Retirement-processing flow — strongest authorship, highlighted */}
          <div className="rounded-2xl border-2 border-accent-pink bg-accent-pink/10 p-6 md:p-8">
            <span className="text-[11px] font-bold tracking-[2.5px] uppercase text-accent-pink mb-3 block">
              {t("solution.retirementFlow.label")}
            </span>
            <h3 className="text-2xl md:text-3xl font-heading font-bold text-text-primary mb-3">
              {t("solution.retirementFlow.title")}
            </h3>
            <p className="font-light text-base md:text-[18px] leading-7.5 text-text-primary">
              {t("solution.retirementFlow.text")}
            </p>
          </div>
        </div>
      </SolutionRenderer>
      ...
      <ResultsRenderer
        id="results"
        number="04"
        label={tc("steps.results")}
        title={t("results.title")}
        description={t("results.description")}
      >
        <div className="space-y-8">
          <div>
            <h3 className="text-base md:text-body-01 text-text-primary font-bold mb-4">
              {t("results.dashboardInbox.title")}
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
              <div>
                <p className="text-body-02 text-text-primary mb-2">
                  {t("results.labels.improvements")}
                </p>
                <ul className="space-y-3">
                  <ResultListItem
                    type="improvement"
                    text={t("results.improvements.0")}
                  />
                  <ResultListItem
                    type="improvement"
                    text={t("results.improvements.1")}
                  />
                </ul>
              </div>
              <div>
                <p className="text-body-02 text-text-primary mb-2">
                  {t("results.labels.attention")}
                </p>
                <ul className="space-y-3">
                  <ResultListItem
                    type="attention"
                    text={t("results.attentions.0")}
                  />
                  <ResultListItem
                    type="attention"
                    text={t("results.attentions.1")}
                  />
                </ul>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
              <div>
                ...
                <ul className="space-y-3">
                  <ResultListItem
                    type="improvement"
                    text={t("results.improvements.2")}
                  />
                  <ResultListItem
                    type="improvement"
                    text={t("results.improvements.3")}
                  />
                  <ResultListItem
                    type="improvement"
                    text={t("results.improvements.4")}
                  />
                  <ResultListItem
                    type="improvement"
                    text={t("results.improvements.5")}
                  />
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-3">
                  <ResultListItem
                    type="attention"
                    text={t("results.attentions.2")}
                  />
                  <ResultListItem
                    type="attention"
                    text={t("results.attentions.3")}
                  />
                  <ResultListItem
                    type="attention"
                    text={t("results.attentions.4")}
                  />
                </ul>
              </div>
            </div>
          ...
          <p className="text-base md:text-body-01 text-text-primary mb-4">
            {t("results.overall.score")}
          </p>
          <p className="text-base md:text-body-01 text-text-secondary max-w-187.5">
          ...
          <div className="pt-12">
            ...
            >
              <div className="flex flex-col gap-6">
                {/* Image Container */}
                <div className="relative w-full h-75 bg-bg-subtle rounded-3xl overflow-hidden border border-border">
                  <img
