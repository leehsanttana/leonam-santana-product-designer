...
export function HeroSection() {
  ...
  return (
    <section id="hero" className="container mx-auto px-4 max-w-[1440px] min-h-screen pt-18 pb-20 flex flex-col justify-center border-b border-border relative overflow-hidden">
      <RetroGrid />
      <div className="relative z-10 w-full flex flex-col">
        ...
        <div className="flex flex-col lg:flex-row gap-8 justify-between items-end max-w-5xl">
          ...
          <div className="flex flex-col md:flex-row items-stretch md:items-center gap-4 w-full lg:w-auto mt-8 lg:mt-0">
