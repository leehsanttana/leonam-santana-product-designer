...
export function AboutSection() {
  ...
  return (
    <section id="about" className="container mx-auto px-ds-sm max-w-360 py-ds-lg lg:py-ds-3xl border-b border-border">
      <div className="grid lg:grid-cols-2 gap-ds-3xl items-center">
        <div className="relative">
          <div className="aspect-4/5 rounded-4xl bg-bg-subtle overflow-hidden border border-border shadow-2xl relative z-10">
            <img
              src="/personal-photo.jpg"
              alt="Leonam Santana"
              className="object-cover"
            />
            <div className="absolute inset-0 bg-linear-to-t from-bg-main/60 to-transparent pointer-events-none" />
          </div>
          {/* Decoration */}
